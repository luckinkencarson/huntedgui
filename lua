...
repeat
 ...
 local function createWatermark()
    ...
    task.spawn(function()
       while task.wait() do
         ...
         WaterMarkLabel.Text = 'hunted.lol.<font color="rgb(255, 5, 9)">prod</font> - uid: <font color="rgb(255, 5, 9)">' .. uid .. '</font> / fps: <font color="rgb(255, 5, 9)">' .. fpsValue .. '</font> / ping: <font color="rgb(255, 5, 9)">' .. ping .. '</font> / time: <font color="rgb(255, 5, 9)">' .. time .. '</font>'
       end
    end)
    return Watermark
 end
 ...
 local library = {
    Title = 'debugged.<font color="rgb(255, 5, 9)">lol</font>',
    ...
    CloneScreenGui.Name = "hunted.lol_gui"
